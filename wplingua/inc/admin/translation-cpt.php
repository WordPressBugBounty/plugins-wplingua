...
function wplng_register_post_type_translation() {
	register_post_type(
		...
		array(
			'labels'              => array(
				'name'          => __( 'wpLingua - Translations', 'wplingua' ),
				'singular_name' => __( 'wpLingua - Translation', 'wplingua' ),
				'all_items'     => __( 'wpLingua - All translations', 'wplingua' ),
				'edit_item'     => __( 'wpLingua - Edit translation', 'wplingua' ),
				'menu_name'     => __( 'Translations', 'wplingua' ),
				'search_items'  => __( 'Search translations', 'wplingua' ),
			),
			'public'              => false,
