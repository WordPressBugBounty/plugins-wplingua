...
function wplng_url_is_translatable_no_filter( $url ) {
	...
	// Exclude files URL
	$regex_is_file = '#\.(avi|css|js|docx?|exe|gif|html?|jfif|jpe?g|webp|bmp|midi?|mp3|mpe?g|avif|mov|qt|pdf|png|ra?m|rar|tiff?|txt|wav|zip|ico|xml|rss|xls[x]?|ttf|otf|woff2?|eot|svg)?\/$#i';
