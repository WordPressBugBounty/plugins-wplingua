=== Translate and boost SEO - Automatic AI translation - wpLingua ===
Contributors: wpr0ck, lyly13, pierrelannoy, wplingua
Donate link: https://wplingua.com/
Tags: ai translation, automatic translation, translate, translation, SEO
 ...
 * WooCommerce: Translate the "Place order" button
 * Contact Form 7: Translate quiz questions
* Improved options page design
 ...
 * Fix icon alignment in Chrome
 * Review size and spacing
* Option pages
 * Fix select input height on WordPress 7.1
 * Fix icon alignment in buttons on WordPress 7.1
